...
| `VITE_DEV_LOGIN_EMAIL` / `VITE_DEV_LOGIN_PASSWORD` | **Só dev** (1.1.0): login rápido de teste. Sem eles, o botão de dev não aparece. **Nunca** setar em produção. |
...
> **CORS das Edge Functions (1.1.0):** não usam mais `Access-Control-Allow-Origin: *` — só `www`/apex
